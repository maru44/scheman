...
func main() {
	...
	rootCmd.PersistentFlags().StringArray("services", []string{}, "Services to be written table definition")
	rootCmd.PersistentFlags().StringArray("erd-outputs", []string{}, "Services to be written ERD (mermaid format)")
